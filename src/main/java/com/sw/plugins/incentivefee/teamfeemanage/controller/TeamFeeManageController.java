package com.sw.plugins.incentivefee.teamfeemanage.controller;
...
import com.sw.plugins.incentivefee.organizationfeemanage.controller.OrganizationFeeManageController;
...
@Controller
public class TeamFeeManageController extends BaseController<IncentiveFeeDetail>{
	
	private static Logger logger = Logger.getLogger(TeamFeeManageController.class);
	...
	@RequestMapping("incentivefee/teamfeemanage")
