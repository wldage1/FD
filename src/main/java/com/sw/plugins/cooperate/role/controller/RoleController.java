package com.sw.plugins.cooperate.role.controller;
...
public class RoleController extends BaseController<Role> {
	 ...
	 * @return
	 */
	@RequestMapping("/cooperate/role")
	public CommonModelAndView list(Role role, HttpServletRequest request)throws Exception {
		User u = new User();
		u.setIsCommission(1);
		List<Organization> orgList = (List<Organization>)userService.getLoginUserSecendOrgList(u);
	 ...
	 * @author
	 */
	@RequestMapping("/cooperate/role/create")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/cooperate/role/save", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping("/cooperate/role/modify")
	 ...
	 * @return
	 */
	@RequestMapping("/cooperate/role/funcauth")
	 ...
	 * @return
	 */
	@RequestMapping("/cooperate/role/authtree")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/cooperate/role/saveauth", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping("/cooperate/role/delete")
	...
	@RequestMapping("/cooperate/role/grid")
	...
	@Override
	@RequestMapping("/cooperate/role/valid")
