...
<script type="text/javascript">
	...
	<body class="skinMain">
		<form:form action="save" method="post" commandName="provider">
			...
			<input type="hidden" name="delStatus" value="1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="skinLayout">
				...
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
						<form:textarea path="substantialShareholder" cols="30" rows="3" maxlength="100" onchange="this.value=$.trim(this.value)" cssStyle="width: 250px; height: 60px;"/>
					</td>
				</tr>
				<tr>
					<td width="15%" align="right" class="skinLayout_info">
				...
				<tr>
					...
					<td width="85%" coldiv="2" align="left">
						<input type="button" class="btn2" name="btnok" value="<msg:message code="button.save"/>" id="btnok">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" class="btn2" onclick="window.location.href='${base}${cooperate_provider.controller}?c=${cooperate_provider.code}&back=1'" name="btnback" value="<msg:message code="button.back"/>" id="btnback"/>
					</td>
				</tr>
			</table>
		</form:form>
