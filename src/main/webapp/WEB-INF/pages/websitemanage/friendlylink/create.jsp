				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
					<tr>
						...
						<td width="85%" class="skinLayout_lable">
							<input name="name" type="text" id="name" style="width: 200;"  class="valid-control"/><font color="red">&nbsp;*&nbsp;</font>
						</td>
					</tr>
					<tr>
						<td width="15%" align="right" class="skinLayout_info"><msg:message code="links.url"/><msg:message code="system.common.sign.colon"/></td>
						<td width="85%" class="skinLayout_lable">
							<form:input path="url" id="url" maxlength="200"  class="valid-control"/><font color="red">&nbsp;*&nbsp;</font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="85%" colspan="2" align="left">
							<input type="button" class="btn2" name="btnok" onclick="save();" value="<msg:message code="button.save"/>" id="btnok"/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
