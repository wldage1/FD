...
<form:input type="hidden" path="isReleased" />
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout" >
			...
			<tr>
				...
				<td width="85%" colspan="2" align="left">
					<input type="button" class="btn2" name="btnok" value="<msg:message code="question.reply"/>" id="btnok" onclick="submmit()"/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" class="btn2" name="btnok" value="<msg:message code="question.replyanddisposed"/>" id="btnok" onclick="submitAndpublish()"/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
