  ...
  //addRow
    <c:forEach var="attribute" items="${attributeList}">
    	...
    	if("${attribute.isEnabled}" == 1){
    		...
    		isEnabled = "<input type='checkbox' id='isEnabled"+(parseInt(count)+1)+"' />";
    	}
    	var isForQuery = "";
	    ...
	    var data_db={
				...
				isNotNull:isNotNull,
				isEnabled:isEnabled,
				pageShowType:"<select id='pageShowType"+(parseInt(count)+1)+"' onchange=\"changeShowType('"+(parseInt(count)+1)+"');\">"+pageShowType_db+"</select><input type='button' id='img"+(parseInt(count)+1)+"' onclick='setValue("+(parseInt(count)+1)+")' value='..' disabled='disabled'/>",
				...
				sortNumber: number,
				operate:operate,
				updateFlag:"<input type='hidden' id='updateFlag"+(parseInt(count)+1)+"' value=\"1\" />"
				};
    	...
    	if("${attribute.pageShowType}" == "2" || "${attribute.pageShowType}" == '3'  || "${attribute.pageShowType}" == '4' || "${attribute.pageShowType}" == '7'|| "${attribute.pageShowType}" == '8'){
			...
			changeShowType((parseInt(count)+1));
		}
