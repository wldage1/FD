		...
		<tr>
			<td width="100%">
				<table align="center" width="100%" border="" cellspacing="1" cellpadding="0" class="skinLayout" >
						...
						<tr>
							<td align="right" class="skinLayout_info" ><msg:message code="product.raiseArea" /><msg:message code="system.common.sign.colon"/></td>
							<td align="left"  colspan="3">
								<c:forEach items="${raiseArea}" var="it"><c:if test="${product.raiseArea==it.key}">${it.value}</c:if></c:forEach>
							</td>
						</tr>
						<tr>
