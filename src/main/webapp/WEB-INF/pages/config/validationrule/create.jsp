...
$(document).ready(function(){
	...
	var src="<#noparse>${base}</#noparse>/common/skin/images/seatcenter/btn/button_outBound_02.png"
	
	var start=src.length-5
	var end=src.length-4
	if (src.substring(start,end)=='2'){
		src=src.substring(0,src.length-5)+1+src.substring(src.length-4,src.length); 
	}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="skinLayout">
				...
				<tr>
					...
					<td width="70%" valign="middle" class="skinLayout_lable">
						<div style="float:left;"><form:textarea path="ruleContent" maxlength='100' cols="30" rows="4" onchange="this.value=$.trim(this.value)" cssStyle="width: 250px; height: 85px;" class="valid-control"/>
						</div>
				...
				<tr>
					...
					<div style="float:left;"><form:textarea cols="30" rows="4" path="promptMessage" maxlength='100' onchange="this.value=$.trim(this.value)" cssStyle="width: 250px; height: 85px;" class="valid-control"/>
					</div>
					<div style="height:85px; line-height:85px; vertical-align:middle">
						<font color="red" >&nbsp;&nbsp;*&nbsp;
						</font>
