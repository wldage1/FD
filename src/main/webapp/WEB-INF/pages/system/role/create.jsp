...
<script type="text/javascript">
	var setting = {
		async: {
			enable: true,
			url:"${base}/system/organization/secendleveltree.json",
			dataType:"json",
			dataFilter: filter
		},
		data: {
	...
	$(document).ready(function() {
		...
		var options = {
				event:'focus',
				ajax:{
					url:'${base}/system/role/valid.json'
				},
...
<input type="hidden" name="turnCode" value="${system_role.code}" />
<form:hidden path="orgId" value="${role.orgId}"/>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				...
				<tr>
					...
					<td width="85%" colspan="2" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:if test="${empty errors}"><input type="button" class="btn2" onclick="window.location.href='${base}${system_role.controller}?c=${system_role.code}&back=1'" name="btnback" value="<msg:message code="button.back"/>" id="btnback"/></c:if>
					</td>
				</tr>
			</table>
		</td>
