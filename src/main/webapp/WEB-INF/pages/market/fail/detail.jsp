			...
			<td width="100%">
				<table align="center" width="100%" border="" cellspacing="1" cellpadding="0" class="skinLayout" >
					...
					<tr>
						...
						<td align="left" class="">${order.teamOrOrgName}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="right" class="skinLayout_info"><msg:message code="order.payMoneyStopTime"/><msg:message code="system.common.sign.colon"/></td>
						<td align="left" class="">${order.payMoneyStopTime}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="right" class="skinLayout_info"><msg:message code="order.fail.time"/><msg:message code="system.common.sign.colon"/></td>
						<td align="left" class="">${order.updateTime}</td>
					</tr>
					<tr>
					...
					<%-- <tr>
						...
						<td align="left"  class="" width="100px">${order.commissionPercent}</td>
						...
						<td align="left"  class=""  width="300px">${order.expectCommission}</td>
						<td align="right" class="skinLayout_info" width="100px"><msg:message code="order.commission"/><msg:message code="system.common.sign.colon"/></td>
						<td align="left" class=""  width="300px">${order.commission}</td>
					</tr>
					<tr>
						...
						<td align="left" class="">${order.salesTax}</td>
						...
						<td align="left" class="" width="100px">${order.constructionTax}</td>
					</tr>
					<tr>
						...
						<td align="left" class="" width="100px">${order.educationalSurtax}</td>
						...
						<td align="left" class="" width="100px">${order.localEducationalCost}</td>
					</tr>
					<tr>
						...
						<td align="left" class="" width="100px">${order.personalIncomeTax}</td>
						...
						<td align="left" class="" width="100px">
							<c:forEach items="${payStatus}" var="item">
								<c:if test="${item.key == order.payStatus}">
									${item.value}
								</c:if>
							</c:forEach>
						</td>
