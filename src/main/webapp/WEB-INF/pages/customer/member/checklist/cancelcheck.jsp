...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" >
	...
	<tr>
		<td>
					<form:form method="post" action="saveCancelMember" commandName="cancelMember">
					<input type="hidden" name="turnCode" value="${customer_member_checklist.code}"/>
					<input type="hidden" name="coverParam" value="1"/>
					<input type="hidden" name="id" id="id" value="${cancelMember.id}"/>
					<input type="hidden" name="checkId" id="cancelCheckId" value="${cancelMember.checkId}"/>
					<input type="hidden" name="checkType" id="cancelCheckType" value="${cancelMember.checkType}"/>
						...
						<tr>
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
										...
										<td width="35%" class="skinLayout_lable">
											<form:input path="iDCard" maxlength='20' readonly='true' onchange="this.value=$.trim(this.value)" class="valid-control"/>
										</td>
									</tr>
									<tr>
										<td width="15%" align="right" class="skinLayout_info">
										...
										<td width="35%" class="skinLayout_lable">
											<form:input path="mobilePhone" maxlength='20' readonly='true' onchange="this.value=$.trim(this.value)" class="valid-control"/>
										</td>
									</tr>
									<tr>
										<td width="15%" align="right" class="skinLayout_info">
		...
		<div class="toolbar">
				<div class="left"></div>
				<div class="center">
				<input type="button" class="btn2" name="cancelbtnok" onclick="saveMemberCheck(2)" value="通过" id="cancelbtnok"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;						
				<input type="button" class="btn2" onclick="backMemberCheck(2)" name="cancelbtnback" value="不通过" id="cancelbtnback"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
