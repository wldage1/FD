...
<html>
	<head>
		...
		$(document).ready(function(){
			<c:if test="${!empty customer_member_account}">
		    <security:authorize ifAnyGranted="${customer_member_account.code}">
			$("#accountDetail").click(function(){
				$.ajax({
   					url: '${base}${customer_member_account.controller}.json',
   					type:'post',
   					timeout:'60000',
   					dataType:'json',
   					data: {id:${member.id}, c:'${customer_member_account.code}'}, 
   					async:false,
   					cache:false,
			...
			$("#idCardDetail").click(function(){
				$.ajax({
   					...
   					timeout:'60000',
   					dataType:'json',
   					data: {id:${member.id}, c:'${customer_member_idcard.code}'}, 
   					async:false,
   					cache:false,
   					success:function(jsonData){
   						if(jsonData.idcard){
			...
			$("#mobilePhoneDetail").click(function(){
				$.ajax({
   					...
   					timeout:'60000',
   					dataType:'json',
   					data: {id:${member.id}, c:'${customer_member_mobilephone.code}'}, 
   					async:false,
   					cache:false,
   					success:function(jsonData){
		    ...
		    <c:if test="${!empty customer_member_homephone}">
		    <security:authorize ifAnyGranted="${customer_member_homephone.code}">
			$("#homePhoneDetail").click(function(){
				$.ajax({
   					url: '${base}${customer_member_homephone.controller}.json',
   					type:'post',
   					timeout:'60000',
   					dataType:'json',
   					data: {id:${member.id}, c:'${customer_member_homephone.code}'}, 
   					async:false,
   					cache:false,
   					success:function(jsonData){
				...
				<td width="100%">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="skinLayout">
						...
						<tr>
							...
							<td width="15%" align="right" class="skinLayout_info">
							<msg:message code="member.bank"/><msg:message code="system.common.sign.colon"/></td>
							<td width="35%" class="skinLayout_lable">
								${member.bank}
							</td>
						</tr>
						<tr>
							<td width="15%" align="right" class="skinLayout_info">
							<msg:message code="member.card"/><msg:message code="system.common.sign.colon"/></td>
							<td width="35%" class="skinLayout_lable">
								${member.card}
							</td>
							<td width="15%" align="right" class="skinLayout_info">
						...
						<tr>
							...
							<td width="35%" class="skinLayout_lable">
							<c:if test="${fn:length(member.email) > 0}">
								*****${fn:substring(member.email, fn:indexOf(member.email, "@"), fn:length(member.email))}
							</c:if>
							</td>
							<td width="15%" align="right" class="skinLayout_info">
						...
						<tr>
							...
							<td width="15%" align="right" class="skinLayout_info">
							<msg:message code="member.contract"/><msg:message code="system.common.sign.colon"/></td>
							<td width="35%" class="skinLayout_lable">
