...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		<td>
					...
					<input type="hidden" name="applicationMember" id="applicationMember" value="${createTeam.applicationMember}"/>
		...
		<div class="toolbar">
				<div class="left"></div>
				<div class="center">
				<input type="button" class="btn2" name="btnok" onclick="saveTeamCheck()" value="通过" id="createbtnok"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" class="btn2" onclick="backTeamCheck()" name="createbtnback" value="不通过" id="createbtnback"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
