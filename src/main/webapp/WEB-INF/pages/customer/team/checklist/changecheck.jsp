...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" >
	...
	<tr>
		...
		<div class="toolbar">
				<div class="left"></div>
				<div class="center">
				<input type="button" class="btn2" name="changebtnok" onclick="saveTeamCheck()" value="通过" id="changebtnok"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;						
				<input type="button" class="btn2" onclick="backTeamCheck()" name="changebtnback" value="不通过" id="changebtnback"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
