...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" >
	...
	<tr>
		<td>
					<form:form method="post" action="" commandName="changeMemberOrganization">
					<input type="hidden" name="turnCode" value="${customer_organization_checklist.code}"/>
					<input type="hidden" name="coverParam" value="1"/>
					<input type="hidden" name="id" id="id" value="${changeMemberOrganization.id}"/>
					<input type="hidden" name="checkId" id="changeCheckId" value="${changeMemberOrganization.checkId}"/>
					<input type="hidden" name="checkType" id="changeCheckType" value="${changeMemberOrganization.checkType}"/>
					<input type="hidden" name="memberID" id="memberID" value="${changeMemberOrganization.memberID}"/>
					<input type="hidden" name="applicationMember" id="applicationMember" value="${changeMemberOrganization.applicationMember}"/>
							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
									...
									<tr>
										...
										<td width="35%" class="skinLayout_lable">
										<img src="${ftpHttpUrl}${changeMemberOrganization.licenceImage}" height="40" width="100" onclick="changeBig('${ftpHttpUrl}${changeMemberOrganization.licenceImage}')">	
										</td>
									</tr>
									<tr>
										<td width="15%" align="right" class="skinLayout_info">
									...
									<tr>
										<td width="15%" align="right" class="skinLayout_info">
											<msg:message code="memberOrganization.memberName"/><msg:message code="system.common.sign.colon"/>
										</td>
										<td width="35%" class="skinLayout_lable">
		...
		<div class="toolbar">
				<div class="left"></div>
				<div class="center">
				<input type="button" class="btn2" name="changebtnok" onclick="saveOrganizationCheck()" value="通过" id="changebtnok"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;						
				<input type="button" class="btn2" onclick="backOrganizationCheck()" name="changebtnback" value="不通过" id="changebtnback"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
