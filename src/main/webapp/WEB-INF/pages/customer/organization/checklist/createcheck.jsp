...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		<td>
					...
					<input type="hidden" name="id" id="id" value="${createMemberOrganization.id}"/>
					<input type="hidden" name="tempOrgID" id="tempOrgID" value="${createMemberOrganization.tempOrgID}"/>
					<input type="hidden" name="applicationMember" id="applicationMember" value="${createMemberOrganization.applicationMember}"/>
					<input type="hidden" name="checkId" id="createCheckId" value="${createMemberOrganization.checkId}"/>
					<input type="hidden" name="checkType" id="createCheckType" value="${createMemberOrganization.checkType}"/>
						...
						<tr>
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
									...
									<tr>
										<td width="15%" align="right" class="skinLayout_info">
											归属机构<msg:message code="system.common.sign.colon"/>
										</td>
										<td width="35%" class="skinLayout_lable">
											<input type="radio"  name="identity" checked="checked" style="width:20px;height:15px;"  value="1" />嘉华机构 
											<input type="radio"  name="identity" style="width:20px;height:15px;"  value="2" />其他机构
										 </td>
										<td width="15%" align="right" class="skinLayout_info">
		...
		<div class="toolbar">
				<div class="left"></div>
				<div class="center">
				<input type="button" class="btn2" name="btnok" onclick="saveOrganizationCheck()" value="通过" id="createbtnok"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" class="btn2" onclick="backOrganizationCheck()" name="createbtnback" value="不通过" id="createbtnback"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
