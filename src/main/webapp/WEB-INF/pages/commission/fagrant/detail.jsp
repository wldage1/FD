...
<input type="hidden" name="turnCode" value="${commission_fagrant_detail.code}"/>
			...
			<td width="100%">
					<table align="center" width="100%" border="" cellspacing="1" cellpadding="0" class="skinLayout" >
						...
						<div class="toolbar">
							<div class="left"></div>
								<div class="center">
									<input type="button" class="btn2" onclick="window.location.href='${base}${commission_fagrant.controller}?c=${commission_fagrant.code}&tab=${tab}'" name="btnback" value="<msg:message code="button.back"/>" id="btnback"/>
								</div>
							<div class="right"></div>
						</div>
					</td>
