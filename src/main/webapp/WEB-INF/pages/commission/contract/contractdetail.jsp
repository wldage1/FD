				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
					...
					<tr>
						...
						<td height="40%" width="70%" style="padding-left:3px;padding-right:6px;" >
							<div style="float:left;"><textarea id="content" name="content" readonly="true" style="height:450px;width:700px;border:0;background:transparent;overflow:auto;" class="valid-control">${contract.content}</textarea></div>
						</td>
					</tr>
