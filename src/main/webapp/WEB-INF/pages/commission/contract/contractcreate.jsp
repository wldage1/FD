...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="skinMain">
	<tr>
		<td width="100%">
			...
			<input type="hidden" name="contractOrgID" value="${contract.contractOrgID}"/>
					...
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
							...
							<div id="fileOperateInfo">
								...
								<input type="text" name="fileUrl" id="fileUrl" style="width: 0;height:0" readonly="readonly" class="valid-control"><font color="red">&nbsp;*&nbsp;</font>
							</div>
							<input type="hidden" name="fileName" id="fileName" style="border:0;background:transparent;" readonly="readonly">
							<div id="fileDel"></div>
						</td>
					</tr>
					<tr>
						...
						<td height="40%" width="70%" style="padding-left:6px;padding-right:6px;" >
							<form:textarea path="contractDescription" cssClass="valid-control" cols="30"  rows="3" onkeypress="return imposeMaxLength(this, 100)" cssStyle="width: 250px; height: 60px;"/>
						</td>
					</tr>
