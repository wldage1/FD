...
<input type="hidden" name="turnCode" value="${commission_organizationgrant_detail.code}"/>
			...
			<td width="100%">
					<table align="center" width="100%" border="" cellspacing="1" cellpadding="0" class="skinLayout" >
							...
							<tr>
								...
								<td align="left" class="" width="100px">${commission.orderHistory.assignedShare }</td>
							</tr>
							<tr>
							...
							<tr>	
								...
								<td align="left" class="" colspan="3">${commission.orderHistory.pushTime}</td>
							</tr>
						...
						<div class="toolbar">
							<div class="left"></div>
								<div class="center">
									<input type="button" class="btn2" onclick="window.location.href='${base}${commission_organizationgrant.controller}?c=${commission_organizationgrant.code}&tab=${tab}'" name="btnback" value="<msg:message code="button.back"/>" id="btnback"/>
								</div>
							<div class="right"></div>
						</div>
					</td>
